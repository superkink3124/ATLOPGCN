...
class GNN(nn.Module):
    ...
    def forward(self, inputs):
        ...
        mention_hidden_state = output_node_hidden_state[:, :num_mention]
        entity_hidden_state = output_node_hidden_state[:, num_mention:num_mention + num_entity]
        sent_hidden_state = output_node_hidden_state[:, num_mention + num_entity:]

        return entity_hidden_state, mention_hidden_state, sent_hidden_state
